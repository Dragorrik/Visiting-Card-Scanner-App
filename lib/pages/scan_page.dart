...
const whatToDo='''Drag the below text and drop it in the require field to store your data...''';
          ...
          child: DragTarget<String>(
              builder: (context,candidateData,rejectedData)=>Container(
                ...
                decoration: BoxDecoration(
                  border: candidateData.isNotEmpty?Border.all(color: Colors.deepPurple.shade200,width: 2):null,
                ),
                child: Row(
                  children: [
                    Expanded(child: Text(dragItem.isEmpty?"Drag here":dragItem)),
